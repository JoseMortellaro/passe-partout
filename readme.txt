...
If you need a plugin to switch the user while you are logged in, you can use <a href="https://wordpress.org/plugins/user-switching/" target="_blank">User Switching</a>, or <a href="https://wordpress.org/plugins/login-as-user/" target="_blank">Login As User</a>.
However, with <a href="https://wordpress.org/plugins/user-switching/">User Switching</a> and <a href="https://wordpress.org/plugins/login-as-user/" target="_blank">Login As User</a> you will not be able to test the login form submission as a different user.
Only with Pass-partout you can log in as a different user starting from the login form submission. You may need it if for example you want to test a learning management system, or the account of a user who bought on your shop, or in whatever situation you need to see what other logged-in users see when they log in.
